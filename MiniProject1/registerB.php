...
background: linear-gradient(to right, rgba(132, 250, 176, 1), rgba(143, 211, 244, 1))
  ...
  <body>
    <?php
      ...
      $mailaddr=$_POST['mail'];
      $result=$conn->query("select * from studentinfo where mail='$mailaddr'");
...
try {
   ...
   /* Set the subject. */
   $mail->Subject = 'OTP to confirm your account.';//
   $otp=rand(1111,9999);
   session_start();
   $_SESSION['otp']=$otp; 
   $_SESSION['mail']=$mailaddr;
              ...
              <div class="row d-flex justify-content-center align-items-center h-100">
                <div class="col-12 col-md-9 col-lg-7 col-xl-6">
                  <div class="card" style="border-radius: 15px;">
                    <div class="card-body p-5">
                      <h2 class="text-uppercase text-center mb-5">Create an account</h2>
                      Mail wasn\'t verified with college database!Try again... 
                      <form method="post" action="registerB.php">
        
                        
        
                        <div class="form-outline mb-4">
                          <input type="email" id="form3Example3cg" name="mail" class="form-control form-control-lg" />
